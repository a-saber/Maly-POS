            ...
            CustomBuildSectionDeatilsView(
                ...
                children: [
                  ...
                  CustomInfoRowDetailsView(
                    ...
                    value:
                        "${salesModel.subtotal?.toAmount() ?? S.of(context).unKnownPrice} ",
                  ),
                  CustomInfoRowDetailsView(
                    label: S.of(context).discountTotal,
                    value:
                        "${salesModel.discountTotal?.toAmount() ?? S.of(context).unKnownPrice} ",
                  ),
                  CustomInfoRowDetailsView(
                    label: S.of(context).totalAfterDiscount,
                    value:
                        "${salesModel.totalAfterDiscount?.toAmount() ?? S.of(context).unKnownPrice} ",
                  ),
                  CustomInfoRowDetailsView(
