...
class GetExpenseCategoriesModel {
  ...
  factory GetExpenseCategoriesModel.fromJson(Map<String, dynamic> json) {
    return GetExpenseCategoriesModel(
      currentPage: json[ApiKeys.currentpage],
      data: json[ApiKeys.data] == null
          ? null
          : List<ExpenseCategoriesModel>.from(json[ApiKeys.data]
              .map((x) => ExpenseCategoriesModel.fromJson(x))),
